...
const EXAMPLE_DATA: Array<Product> = [
...
export class ProductRead2DataSource extends DataSource<Product> {
  data: Array<Product> = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<Array<Product>> {
   ...
   */
  private getPagedData(data: Array<Product>): Array<Product> {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Array<Product>): Array<Product> {
